                                ...
                                {this.state.cartList.map( (item) => (
                                    <div key={item.id} className="product-widget">
                                        <div className="product-img">
                                            <img  src={product.photo ? `http://localhost:8000/storage/${product.photo}` : 'default-placeholder.jpg'}/>
                                            {/* src={`./img/${JSON.parse(item.stock.product.photo)[0]}`} alt={JSON.parse(item.stock.product.photo)[0]} */}
                                        </div>
